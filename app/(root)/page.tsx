...
const Page = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-black items-center">
      <div className="items-center md:flex justify-center lg:w-2/5 w-1/5 hidden">
        <Image
          src={hero}
          alt="hero picture"
          width={500}
      ...
      <div className="md:h-[40rem] h-auto flex pt-8 md:pt-0">
        <div className="relative md:text-4xl text-2xl mx-auto top-1/4 md:left-12 font-normal text-neutral-600 dark:text-neutral-400 md:w-full w-5/6">
          <div className="md:block flex flex-col">
            Your Gateway to
            <div >
              <FlipWords words={words} />'S
            </div>
             <br />
            Wonders
          </div>
