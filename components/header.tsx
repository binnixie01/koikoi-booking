...
const Header = () => {
  ...
  return (
    <header className="flex w-full h-12 bg-black pt-2 fixed">
      <div className="flex wrapper items-center justify-between text-white/80">
        ...
        <Link className=" hover:text-white" href={"/orders"}>Orders</Link></div>
